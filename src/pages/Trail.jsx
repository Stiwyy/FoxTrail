...
import bluetenblatt from '../assets/bluetenblatt.jpeg'
import kartegaerten from '../assets/karte-gaertner.jpeg'
...
const steps = [
    ...
    // Part 3: Story – Ankunft im Museum
    {
        ...
        type: 'story',
        content:
            'Das Museum wirkt ruhig, doch die Sicherheitsvorkehrungen wurden offensichtlich verschärft. Du wirst zum Direktor geführt, der dich prüfend mustert. Als du vom Dolch sprichst, wird sein Blick schärfer. "Informationen sind kostbar", sagt er. "Bevor ich Ihnen etwas verrate, müssen Sie zeigen, dass Sie Augen für Details haben..."',
    },
    ...
    // Part 4: Story – Die nächste Spur
    {
        ...
        type: 'story',
        content:
            'Der Direktor nickt langsam. "Sehr gut", sagt er. "Nur wer Details erkennt, findet die Wahrheit." Er führt dich in ein Hinterzimmer, wo sich ein altes Verzeichnis der Sonderausstellung befindet. Einige Seiten fehlen. Einer der vermissten Gegenstände: Ein Ritualdolch aus dem 16. Jahrhundert. Der Titel der Sammlung: "Die Schatten der Menschheit". Ausserdem ein roter Plexiglas Würfel, der dich an einen neuen Ort Lenkt.',
    },
    {
        id: 'story-5',
        type: 'story',
    ...
    },
    {
        ...
        type: 'question',
        riddle:
            'Was steht auf dem Schild unter dem Namen des Autors bei der Statue?',
    ...
    },
    {
        ...
        type: 'question',
        riddle:
            'Wie lautet der wissenschaftliche Name der Pflanze, die du vor dem Bundesgericht siehst?',
    ...
    },
    {
        ...
        description:
            'Trage hier den vollständigen Namen und das Alter des Täters ein, um den Fall abzuschliessen. Nur wer richtig liegt, kann den Foxtrail erfolgreich beenden.',
        fields: [
            {
        ...
        <>
            <div className="container">
                ...
                <div className="header-toolbar">
                    ...
                    {/* Hinweis Button: Jetzt immer sichtbar */}
                    <button
